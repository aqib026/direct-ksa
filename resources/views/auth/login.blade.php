                    ...
                    <form method="POST" id='login_form' action="" class="auth-form">
                        ...
                        <div class='row'>
                            <div role="group" class="mb-1 btn-group btn-group-sm">
                                <button type="button" class="btn shadow-none btn-primary py-2" id='phone_btn' onclick="showFields('phone')">Mobile No</button>
                                <button type="button" class="btn shadow-none btn-outline-primary py-2" id='email_btn' onclick="showFields('email')">Email</button>
                        ...
                        <div role="group" class="input-group mt-3" id='phone_field'><!---->
                            ...
                            <div class="input-group-append">
                                <div class="input-group-text"><svg xmlns="http://www.w3.org/2000/svg" width="14px" height="14px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-smartphone">
                        ...
                        <div class="text-center text-lg-start mt-4 pt-2" id='login_filed'>
                            <button type="button" id='login_with_OTP' class="btn btn-primary btn-lg submit d-block w-100">
                                Login With OTP
                            </button>

                            <button type="button" id='login_with_Pass' style='display:none' class="btn btn-primary btn-lg submit w-100 mt-3">
                                Login
                            </button>
                            ...
                            <p class="small fw-bold mt-2 mb-0">Don't have an account? <a href="{{url('/register')}}" class="link-danger">Register</a></p>
