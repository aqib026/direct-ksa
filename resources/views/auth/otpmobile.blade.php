            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    ...
                    <!-- Email input -->
                        ...
                        <div class="">
                            <input id="number" type="number" class="form-control @error('number') is-invalid @enderror" name="number" value="@auth {{  Auth::user()->number }} @endauth" required autocomplete="number" autofocus>
