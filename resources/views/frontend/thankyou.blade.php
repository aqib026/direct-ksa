	...
	<div class="container">
        <div class="row">
            <div class="col text-center m-5 p-5">
                ...
                <a href="http://localhost:8000/visa_request" data-hash=""  data-hash-offset="0" data-hash-offset-lg="100" class="btn btn-modern btn-primary btn-arrow-effect-1 text-capitalize text-3-5 px-5 py-3 anim-hover-translate-top-5px transition-2ms">Return To Home Screen<i class="fas fa-arrow-right ms-2"></i></a>            </div>
        </div>
    </div>
</section>
@endsection