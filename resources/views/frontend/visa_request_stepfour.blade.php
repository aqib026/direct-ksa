			...
			<div class="col-lg-12">
				<div class="card card-default mb-5">
					<div class="card-header" id="collapse100One">
						<h4 class="card-title m-0 text-center">
							<a class="accordion-toggle text-center text-color-dark font-weight-bold" data-bs-toggle="collapse" data-bs-target="#collapse1001" aria-expanded="true" aria-controls="collapse1001">{{__('step4.TravelerInformation')}}</a>
						</h4>
					</div>
					<div id="collapse1001" class="collapse show" aria-labelledby="collapse100One" data-bs-parent="#accordion100">
						<div class="card-body">
							<h4 class="text-center m-4 mb-5">{{__('step4.Before')}}</h4>
							<table class="table">
								<thead>
									<tr>
										<th>{{__('step4.CountryVisaType')}}</th>
									</tr>
								</thead>
								<tbody>
									<tr>
							...
							<table class="table">
								<thead>
									<tr>
										<th>{{__('step4.TravelDate')}}</th>
									</tr>
								</thead>
								<tbody>
									<tr>
										<td>
											<p>{{__('step4.Expected')}}</p>
				...
				<div class="card card-default mb-5">
					<div class="card-header" id="collapse100Two">
						<h4 class="card-title m-0 text-center">
							<a class="accordion-toggle text-center text-color-dark font-weight-bold" data-bs-toggle="collapse" data-bs-target="#collapse1002" aria-expanded="true" aria-controls="collapse1002">{{__('step4.Payment')}}</a>
						</h4>
					</div>
					<div id="collapse1002" class="collapse show" aria-labelledby="collapse100Two" data-bs-parent="#accordion100">
						<div class="card-body">
							...
							<table class="table table-hover">
								<thead>
									<tr>
										<th class="text-left">{{__('step4.Order')}}</th>
										<th class="text-right">{{__('step4.Total')}}</th>
									</tr>
								</thead>
								<tbody>
									<tr>
									...
									<tr>
										<td class="text-left">{{__('step4.Total')}}</td>
							...
							<table class="table table-borderless">
								<thead>
									<tr>
										<th class="text-left">{{__('step4.TotalPayment')}}</th>
				...
				<div class="card card-default mb-5">
					<div class="card-header" id="collapse100Three">
						<h4 class="card-title m-0 text-center">
							<a class="accordion-toggle text-center text-color-dark font-weight-bold" data-bs-toggle="collapse" data-bs-target="#collapse1003" aria-expanded="true" aria-controls="collapse1003">{{__('step4.PaymentMethod')}}</a>
						</h4>
					</div>
						...
						<div class="card-body">
							...
							<form action="{{ route('visa_request_stepfour_post') }}" role="form" method="post" class="form-horizontal" enctype="multipart/form-data" id="visa_req_form">
								...
								<table class="table">
									<thead>
										<tr>
											<th class="text-left"><i class="fa fa-receipt"></i>&nbsp;&nbsp;&nbsp;{{__('step4.Cash')}} <span class="mx-5 badge badge-secondary px-3 py-2"><a class="popup-with-zoom-anim" href="#branches-dialog" style="color: #FFF;">{{__('step4.ViewBranch')}}</a></span></th>
										...
										<tr>
											<th class="text-left"><i class="fa fa-bank"></i>&nbsp;&nbsp;&nbsp;{{__('step4.Bank')}} <span class="mx-5 badge badge-secondary px-3 py-2"><a class="popup-with-zoom-anim" href="#banks-dialog"  style="color: #FFF;">{{__('step4.ViewBank')}}</a></span></th>
                                        ...
                                        <tr>
                                            <th class="text-left"><i class="fa fa-dollar"></i>&nbsp;&nbsp;&nbsp;{{__('step4.Online')}} <span class="mx-5 badge badge-secondary px-3 py-2"></span></th>
								...
								<div class="text-center my-5">
									<button class="btn btn-modern btn-primary btn-arrow-effect-1 btn-xl mb-2" type="submit">{{__('step4.confirm')}}</button>
