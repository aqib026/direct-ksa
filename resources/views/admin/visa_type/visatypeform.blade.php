                ...
                <div class="page-title">
                    ...
                    <div class="title_right">
                        <div class="col-md-2 col-sm-2  form-group pull-right top_search">
                            <a href="{{ url('admin/visatype') }}"><button class="btn btn-danger">Back</button></a>
                        </div>
                    </div>
                </div>
                                ...
                                <form method="POST" action="{{ $url }}" enctype="multipart/form-data">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <select name="name" id=""
                                                value="{{ old('name', isset($VisaRequest) ? $VisaRequest->name : '') }}" class="form-control">
        
                                                <option value="{{ old('name', isset($VisaRequest) ? $VisaRequest->visatype->id : '') }}">{{ old('name', isset($VisaRequest) ? $VisaRequest->visatype->name : '') }}</option>
                                    ...
                                    <div class="item form-group">
                                        <div class="col-md-6 col-sm-6 offset-md-3">
                                            <a href="{{ url('../admin/visarequest') }}"> <button
